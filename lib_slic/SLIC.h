...
public:
	...
	//============================================================================
        ...
        //============================================================================
        // Superpixel segmentation for a given step size with more than one dimension
        //============================================================================
            void DoSuperpixelSegmentation_ForGivenSuperpixelStep_MultipleDimensions(
                    std::vector<cv::Mat>                            ubuff,//Each an Array of 32 bit unsigned int containing ARGB Pixel values.
                const int					width,
                const int					height,
                const int					depth,
                int*&						klabels,
            ...
            //============================================================================
                void DoSuperpixelSegmentation_ForGivenSuperpixelStep_MultipleDimensions(
                        std::vector<std::vector<unsigned int>>                            ubuff,//Each an Array of 32 bit unsigned int containing ARGB Pixel values.
                    const int					width,
                    const int					height,
                    const int					depth,
                    int*&						klabels,
...
private:
	...
	void PerformSuperpixelSLIC(
		...
		const float&				m = 10.0,
                const int                               iterations = 10);
    //============================================================================
    // The main SLIC algorithm for generating multidimensional superpixels
    //============================================================================
    void PerformSuperpixelSLIC(
	...
	void GetLABXYSeeds_ForGivenStepSize(
		...
		const vector<float>&		edgemag);
    //============================================================================
    // Pick seeds for multidimension superpixels when step size of superpixels is given.
    //============================================================================
    void GetLABXYSeeds_ForGivenStepSize(
        vector<vector<float>>&				kseedsl,
        vector<vector<float>>&				kseedsa,
    ...
    //============================================================================
    // Move the multidimensional superpixel seeds to low gradient positions to avoid putting seeds
    // at region boundaries.
    //============================================================================
    void PerturbSeeds(
        vector<vector<float>>&				kseedsl,
	...
	void DetectLabEdges(
        ...
        vector<float>&				edges);
    //============================================================================
    // Detect color edges averaged over all dimension, to help PerturbSeeds()
    //============================================================================
    void DetectLabEdges(
        float**				lvec,
        float**				avec,
    ...
    void DoRGBtoLABConversion( std::vector< cv::Mat >& img);
	//============================================================================
...
private:
	...
	float*							m_bvec;
     ...
     std::vector<std::vector<float>>					m_lvecvec;
     std::vector<std::vector<float>>					m_avecvec;
     std::vector<std::vector<float>>					m_bvecvec;
