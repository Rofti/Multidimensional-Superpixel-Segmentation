...
public:
    ...
    SPSegmentationEngine(SPSegmentationParameters params, std::vector<Mat> img, Mat depthImg = Mat());
...
private:
    void Initialize(Superpixel* spGenerator(int, int, int));
